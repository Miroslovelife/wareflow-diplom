...
export const Login: React.FC = () => {
    ...
    return (
        <div className="relative">
            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 z-20">
                <div className="relatve max-w-md w-full space-y-8 z-20">
